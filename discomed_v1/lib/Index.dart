            ...
            sliver: SliverGrid.count(
              ...
              children: <Widget>[
                ElevatedButton(
                  ...
                  children: [
                    Icon(Icons.timeline,size: iconesize,),
                    Text("HISTÓRICO DESP.",style: TextStyle(fontSize: MediaQuery.of(context).size.height*0.01),),
                  ],
                )
                ),
                ElevatedButton(
                  style: ButtonStyle(
                    ...
                    backgroundColor: MaterialStateProperty.all(Color.fromARGB(255, 154, 205, 50)),
                  ),
                  onPressed: (){
                    Get.toNamed("/despesa?device=phone&id=${_id} &nome=${_nome}");
                  },
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.monetization_on,size: iconesize,),
                      Text("DESPESA",style: TextStyle(fontSize: fontSizeButton),),
                    ],
                  ) //
                ),
                ElevatedButton(
                  ...
                  onPressed: (){
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("KM RODADO",style: TextStyle(fontSize: fontSizeButton),),
                        Text("Carro Próprio",style: TextStyle(fontSize: 12,color: Colors.white70),),
                      ],
                    )),
                ElevatedButton(
                  style: ButtonStyle(
                    ...
                    backgroundColor: MaterialStateProperty.all(Color.fromARGB(255, 255, 215, 0)),
                  ),
                  onPressed: (){Get.toNamed("/telaHistoricoKm?device=phone&visualizada=sim&id=${_id}&nome=${_nome}");},
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Text("HISTÓRICO KM",style: TextStyle(fontSize: fontSizeButton),),
                      ],
                    )),
                ElevatedButton(
                    ...
                    onPressed: (){
                      Get.toNamed("/telavistoria2?device=phone&visualizada=sim&id=${_id}&nome=${_nome}");
                      //_mudaIcone();
                      //Get.snackbar("", "Opção indisponível!",colorText: Colors.white ,snackPosition: SnackPosition.BOTTOM,backgroundColor: Colors.black);
                    }, child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.assistant_photo,size: iconesize,),
                    Text("VISRORIA.",style: TextStyle(fontSize: fontSizeButton),),
                  ],
                )
                ),
                ElevatedButton(
                    ...
                    style: ButtonStyle(
                      ...
                      backgroundColor: MaterialStateProperty.all(Color.fromARGB(255,79, 242, 230)),
                    ),
                    onPressed: (){
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.add_photo_alternate,size: iconesize,),
                    Text("Canhotos",style: TextStyle(fontSize: fontSizeButton),),
                  ],
                )
                ),
      ...
      /*drawer: Drawer(
        ...
        body: Column(
          children: <Widget>[
            ...
            layoutAtual(Colors.blueGrey, corIcon, corTextIcon, Colors.black45, context)
            /*Container(
              height: 10,
