...
class TelaVistoria2 extends StatefulWidget {
  @override
  _TelaVistoria2State createState() => _TelaVistoria2State();
}

class _TelaVistoria2State extends State<TelaVistoria2> {
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text('${listaVistoNichos[position].descricao}',style: TextStyle(fontSize: 12.0,color: Colors.grey),),
                                  ],
                                ),
                              )
                            ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Vistoria Nova"),),
      body: Column(
        children: [
          /*Container(
              width: MediaQuery.of(context).size.width,
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: (){
                    print("Opção é: ${_textEditingControllerItem.text}");
