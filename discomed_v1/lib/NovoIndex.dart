...
class NovoIndex extends StatefulWidget {

  @override
  _NovoIndexState createState() => _NovoIndexState();
}

class _NovoIndexState extends State<NovoIndex> {
  ...
  String _vist = "";
  final Color corborda = Colors.black87;
  final Color corbotao = Colors.white;
  final Color corIconButton = Colors.black87;
            ...
            sliver: SliverGrid.count(
              ...
              children: <Widget>[
                ElevatedButton(
                    ...
                    style: ButtonStyle(
                      side: MaterialStateProperty.all<BorderSide>(BorderSide(width: 1.0,color: corborda),),
                  ...
                  children: [
                    Icon(Icons.timeline,size: iconesize,color: corIconButton,),
                    Text("HISTÓRICO DESP.",style: TextStyle(color: corIconButton,fontSize: MediaQuery.of(context).size.height*0.01)),
                  ],
                )
                ),
                ElevatedButton(
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.monetization_on,size: iconesize,color: corIconButton,),
                        Text("DESPESA",style: TextStyle(color: corIconButton,fontSize: fontSizeButton),),
                      ],
                    ) //
                ),
                ElevatedButton(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("KM RODADO",style: TextStyle(color: corIconButton,fontSize: fontSizeButton),),
                        Text("Carro Próprio",style: TextStyle(fontSize: 12,color: corIconButton),),
                      ],
                    )),
                ElevatedButton(
                    style: ButtonStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("HISTÓRICO KM",style: TextStyle(color: corIconButton,fontSize: fontSizeButton),),
                      ],
                    )),
                ElevatedButton(
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.assistant_photo,size: iconesize,color: corIconButton,),
                    Text("VISTORIA.",style: TextStyle(color: corIconButton,fontSize: fontSizeButton),),
                  ],
                )
                ),
                ElevatedButton(
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.add_photo_alternate,size: iconesize,color: corIconButton,),
                    Text("Canhotos",style: TextStyle(color: corIconButton,fontSize: fontSizeButton),),
                  ],
                )
                ),
    ...
    return Scaffold(
        ...
        //leading: IconButton(icon: Icon(Icons.menu,color: Colors.white,), onPressed: (){Get.toNamed("/menu");}),
          ...
          actions: <Widget>[
            IconButton(icon: Icon(_tt == 'true'  ? Icons.notifications_active : Icons.notifications_none),
                color: _tt == 'true' ? Colors.yellow : Colors.white,
                onPressed: (){
          ...
          title: Column(
            children: <Widget>[
              ...
              Text("Despesas".toUpperCase(),style: TextStyle(fontSize: 13,color: Colors.deepOrange),),
              Padding(
      ...
      body: Column(
        children: <Widget>[
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Align(
                      ...
                      child: Image.asset("img/header.png", height: 100,)
                  ),
          ...
          layoutAtual(Colors.grey[200], Colors.red, Colors.deepOrange, Colors.white, context)
        ],
      ),
